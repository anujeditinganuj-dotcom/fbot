...
async def _send_youtube_playlist(client: Client, m: Message, link: str):
    ...
    for idx, entry in enumerate(entries, start=1):
        ...
        try:
            ...
            stream_url = await asyncio.to_thread(ytdlp.pick_quality_near, video_url, 720)
            ...
            def _blocking_dl(_vu=video_url, _op=out_path, _su=stream_url):
                try:
                    ytdlp.download_video(_vu, _op, on_progress=_on_progress, stream_url=_su)
