...
_API_LATEST_URLS = [
    # These JSON endpoints work on cloud IPs (no browser render needed)
    ...
    "https://www.xvideos.com/api/search?sort=uploaddate&p=0",
]

# HTML scrape URLs — often 404/blocked on cloud IPs; kept as last resort
_HTML_LATEST_URLS: list = []   # disabled: /new-videos/* always 404 on Render
